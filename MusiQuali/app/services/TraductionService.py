    ...
    def tradAdmin(self):
        return {
            "fr" : {
                ...
                "voir_logs" : "Voir logs",
                "rien_rasp" : "Aucune Raspberry trouvée.",
                "etape" : "Les étapes pour configurer votre Raspberry :",
                "conn" : "Pour pouvoir connecter la Raspberry il y a 3 informations nécéssaire qui nécéssite de chercher directement dans la Raspberry :",
                "user" : "Utilisateur ",
                "tape_com" : "il faut taper la commande",
                "cherche_ligne" : "et chercher à la ligne",
                "iptrouveici" : "IPSETROUVEICI",
                "adressereseau" : "ADRESSERESEAU",
                "premier_val" : "ou la première valeur avec la commande",
                "creation_rasp" : "Il est défini lors de la création du Raspberry",
                "fermer" : "Fermer",
                "requete" : "Requêtes ",
                "sujet" : "Sujet ",
                "from" : "De ",
                "rien_req" : "Aucune requête en attente.",
                "select_req" : "Sélectionnez une requête à gauche pour voir les détails.",
                "role_demande" : "Rôle demandeur ",
                "id_entreprise" : "ID Entreprise ",
                "role_demander" : "Le rôle demandé est ",
            ...
            "en" : {
                ...
                "hors_ligne" : "Offline",
                "voir_logs" : "View logs",
                "rien_rasp" : "No Raspberry found.",
                "etape" : "Steps to set up your Raspberry IP:",
                "conn" : "To connect the Raspberry IP, there are three pieces of information you need to look up directly on the Raspberry Pi itself:",
                "user" : "User",
                "tape_com" : "you need to type the command",
                "cherche_ligne" : "and search by line",
                "iptrouveici" : "IPISHERE",
                "adressereseau" : "NETWORKADDRESS",
                "premier_val" : "or the first value using the command",
                "creation_rasp" : "It is defined when the Raspberry is created",
                "fermer" : "Close",
                "requete" : "Requests",
                "sujet" : "Topic",
                "from" : "From",
                "rien_req" : "No pending requests.",
                "select_req" : "Select a query on the left to view the details.",
                "role_demande" : "Applicant role",
                "id_entreprise" : "Company ID",
                "role_demander" : "The requested role is ",
